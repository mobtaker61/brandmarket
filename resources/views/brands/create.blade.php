                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            required
                        >
                            <option value="active" {{ old('brand_status') == 'active' ? 'selected' : '' }}>فعال</option>
                            <option value="inactive" {{ old('brand_status') == 'inactive' ? 'selected' : '' }}>غیرفعال</option>
                            <option value="pending" {{ old('brand_status') == 'pending' ? 'selected' : '' }}>در انتظار</option>
                        </select>
                        @error('brand_status')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
